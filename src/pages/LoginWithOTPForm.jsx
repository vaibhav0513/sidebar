    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100 p-4">
      <div className="flex flex-col md:flex-row w-full max-w-5xl bg-white shadow-lg rounded-lg overflow-hidden min-h-[500px]">
        ...
        <div className="w-full md:w-1/2 bg-gray-900 flex flex-col items-center justify-center py-6 text-white">
          ...
          <h1 className="text-lg md:text-2xl font-bold mt-2 text-center">Peak Performance Students</h1>
        </div>

        {/* Right Side - Form */}
        <div className="w-full md:w-1/2 flex items-center justify-center p-6">
          <form className="w-full max-w-md">
            <h2 className="text-2xl text-yellow-600 font-semibold mb-6 text-center">Login with OTP</h2>
            ...
            <div className="mb-4">
              ...
              <div className="flex border border-gray-300 rounded focus-within:ring-2 focus-within:ring-blue-500">
                ...
                <button
                  type="button"
                  className={`px-3 rounded-r ${otpSent ? "bg-gray-400 cursor-not-allowed" : "bg-green-600 text-white hover:bg-green-700"}`}
            ...
            {otpSent && (
              <button type="button" className="w-full bg-yellow-600 text-white p-2 rounded hover:bg-yellow-700 mt-6" onClick={handleVerifyOTP}>
                Verify OTP
              </button>
            )}
